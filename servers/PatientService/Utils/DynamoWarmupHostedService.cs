...
namespace PatientService.Utils
{
    public class DynamoWarmupHostedService : IHostedService
    {
        ...
        public async Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            {
                _configuration["DynamoDB:PatientProfileTable"] ?? "prm392-patient-profiles",
                _configuration["DynamoDB:BlogTable"] ?? "prm392-blogs",
                _configuration["DynamoDB:PatientReportTable"] ?? "prm392-patient-reports"
            };
