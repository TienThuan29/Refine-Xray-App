...
//     return typeof globalThis !== 'undefined' && !!g.crypto && !!g.crypto?.subtle && typeof process !== 'undefined';
// }
...
//         const keyData = utf8ToUint8(key) as BufferSource;
...
//             ['sign']
//         );
//         const sig = await cryptoSubtle.sign('HMAC', cryptoKey, utf8ToUint8(msg) as BufferSource);
...
//             ['sign']
//         );
//         const sig = await subtle.sign('HMAC', cryptoKey, utf8ToUint8(msg) as BufferSource);
//         return uint8ToHex(new Uint8Array(sig));
//     }
